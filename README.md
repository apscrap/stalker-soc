...
13. В HUD прицел-крестик заменён на точку. Тем не менее, я рекомендую полностью отключить прицел в настройках игры (об этом написано ниже).
14. В HUD добавлена шкала облучения радиацией (интегрирован мод `UI Radiation Mod 0.3`).
15. Исправлены названия всех видов оружия на настоящие. Исправлено огромное количество грамматических ошибок в оригинальных текстах и диалогах.
