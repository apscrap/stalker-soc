...
> 
> В архиве находится файл `userDefineLang.xml`, который нужно закинуть либо в корневую папку Notepad++ (если используется portable-версия), либо в `%APPDATA%\Notepad++` (если используется обычная версия с инсталлятором). Теперь файлы с рашстирением `.ltx` будут подсвечиваться автоматически при открытии их через Notepad++.
> 
