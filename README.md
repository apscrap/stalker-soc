...
6. Значительная часть ценных предметов и абсолютно все артефакты разложены по локациям вручную с большой тщательностью. Исследуйте мир заново: орлиная наблюдательность, кошачье любопытство и носорожий паркур будут вознаграждены.
7. Полностью перебалансированы лут с противников и содержимое тайников.
8. Полностью перебалансированы экономика и торговцы, реализована прогрессия доступности товаров. Заглядывайте в магазины после важных событий — там появляется много чего интересного.
...
11. Убран звуковой сигнал детектора аномалий, работает только звуковой сигнал счетчика Гейгера. Теперь аномалии стали опаснее, и нужно соблюдать осторожность при приближении к ним.
...
14. В HUD прицел-крестик заменён на точку. Тем не менее, я рекомендую полностью отключить прицел в настройках игры (об этом написано ниже).
15. В HUD добавлена шкала облучения радиацией (интегрирован мод `UI Radiation Mod 0.3`).
16. Исправлены названия всех видов оружия на настоящие. Исправлено огромное количество грамматических ошибок в оригинальных текстах и диалогах.
...
3. Для ценителей разнообразия сталкерских анекдотов у костра в состав мода включен специальный архив из всех анекдотов, входящих в трилогию: Тень Чернобыля, Чистое Небо, Зов Припяти. Если вам не нужны дополнительные анекдоты, удалите папку `c:\games\stalker\gamedata\sounds\characters_voice\`. 
5. Если вы любитель обмазывания другими модами, то совместимости с ними ожидать не следует. Я распаковывал архивы игры и вносил изменения в оригинальные файлы. Софт для распаковки [прикладываю](/soft).
