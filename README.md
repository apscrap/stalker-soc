...
6. Значительная часть ценных предметов и абсолютно все артефакты разложены по локациям вручную с большой тщательностью. Исследуйте мир заново: орлиная наблюдательность, неуёмное любопытство и умелый паркур будут вознаграждены.
...
13. В HUD прицел-крестик заменён на точку.
